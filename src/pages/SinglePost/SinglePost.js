    ...
    return (
        ...
        <div className='singlepost'>
            ...
            <div className='singlepost-descr'>
                <h3>Используйте когда вам необходим дополнительный заряд энергии, чтобы оставаться в тонусе.</h3>
                <h2>Вкус: Ментол<br></br>
                    Ресурс использования до 200 вдохов<br></br>
